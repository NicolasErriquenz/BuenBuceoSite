<?php
	...
	add_filter('revslider_getUsedFonts', 'zurf_revslider_getUsedFonts');
	if( !function_exists('zurf_revslider_getUsedFonts') ){
		function zurf_revslider_getUsedFonts( $used_font ){
