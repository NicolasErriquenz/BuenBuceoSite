	...
	if( !function_exists('zurf_register_required_plugins') ){
		function zurf_register_required_plugins(){
			...
			$plugins = array(
				...
				array(
					'name'               => esc_html__('Goodlayers Core', 'zurf'),
				...
				array(
					'name'               => esc_html__('Goodlayers Core Portfolio', 'zurf'),
				...
				array(
					'name'               => esc_html__('Goodlayers Core Personnel', 'zurf'),
				...
				array(
					'name'               => esc_html__('Goodlayers Core Twitter', 'zurf'),
				...
				array(
					'name'               => esc_html__('Revolution Slider', 'zurf'),
					'slug'               => 'revslider', 
			...
			# $tgmpa = call_user_func(array(get_class($GLOBALS['tgmpa']), 'get_instance'));
			# echo json_encode($tgmpa->get_plugins_api('contact-form-7'));
