...
get_header();
	...
	echo '<div class="tourmaster-page-content tourmaster-' . esc_attr(empty($_GET['action'])? 'login': $_GET['action']) . '-template-content  tourmaster-item-pdlr" >';
...
<?php
	...
	///////////////////////////
		...
		if( !empty($rp_key_error) ){
			...
			echo '<p><a href="' . esc_url(add_query_arg(array('source'=>'tm'), wp_lostpassword_url())) . '" >';
			...
			if( !empty($rp_success) ){
				...
				echo '<p><a href="' . esc_url(tourmaster_get_template_url('login')) . '" >';
