              ...
              <div class="row">
                  <div class="col s12">
                      <div class="card-panel custom-card-panel">
                          ...
                          <div class="input-field custom-input-field" style="margin-bottom: 31px;">
                              <p class="inline">
                          ...
                          <div class="input-field custom-input-field">
                              <label for="cotizacion" class="custom-label active">Cotización</label>
                              <input id="cotizacion" name="cotizacion" type="number" step="any" 
                                     value="<?php echo isset($pago['cotizacion']) ? $pago['cotizacion'] : getCotizacion(); ?>">
                          </div>
                          ...
                          <div class="input-field custom-input-field">
                              <label for="medioPagoId" class="custom-label active">Medio de pago</label>
                              <select id="medioPagoId" name="medioPagoId" class="browser-default custom-select">
