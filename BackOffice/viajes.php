        ...
        <div class="col-12">
          <div class="card mb-4" style="padding: 18px;">
            <div class="card-header pb-0">
              <h6 class="float-start">Listado de viajes</h6>
              <div class="float-end">
                ...
                <?php endif; ?>
                <a href="viajes_editar.php">
                  <button class="btn btn-sm btn-icon bg-gradient-primary float-end" data-toggle="tooltip" data-original-title="Agregar viaje">
                      <i class="ni ni-fat-add"></i> AGREGAR VIAJE
                  </button>
                </a>
              </div>
            </div>
                      ...
                      <tr>
                        ...
                        <td>
                          <p class="text-sm font-weight-bold mb-0">
                            <?php 
                              $fecha_inicio = date("d-m-Y", strtotime($item["fecha_inicio"])); 
                              $fecha_fin = date("d-m-Y", strtotime($item["fecha_fin"])); 
                            ?>
                        ...
                        <td class="text-center">
                          <p class="text-sm font-weight-bold mb-0">
                            <?php echo $item["cantidad_usuarios"] ?? 0 ?>
                          </p>
                        </td>
                        <td class="text-center">
